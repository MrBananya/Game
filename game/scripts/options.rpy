...
define config.name = _("My new dead life")
...
define gui.about = _p("""Игра была сделана в качестве пробного проекта который хотелось бы развивать и довести в будущем до ума.
""")
...
define build.name = "Mynewdeadlife"
...
define config.save_directory = "Mynewdeadlife-0.1"
